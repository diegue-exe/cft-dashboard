...
@Component({
  selector: 'app-balance-area-all',
  templateUrl: './balance-area-all.component.html',
  styleUrls: ['./balance-area-all.component.css']
})
export class BalanceAreaAllComponent implements OnInit {
  ...
  ngOnInit(): void {
      this.dataService
      .getBalances(this.currentUser.mt_user_id, 'all')
      .pipe(take(1))
      .subscribe(data => {
