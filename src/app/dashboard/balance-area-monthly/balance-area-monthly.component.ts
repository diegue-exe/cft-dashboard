...
@Component({
  selector: 'app-balance-area-monthly',
  templateUrl: './balance-area-monthly.component.html',
  styleUrls: ['./balance-area-monthly.component.css']
})
export class BalanceAreaMonthlyComponent implements OnInit {
