...
@Component({
  selector: 'app-balance-area-yearly',
  templateUrl: './balance-area-yearly.component.html',
  styleUrls: ['./balance-area-yearly.component.css']
})
export class BalanceAreaYearlyComponent implements OnInit {
  ...
  ngOnInit(): void {
      this.dataService
      .getBalances(this.currentUser.mt_user_id, '1year')
      .pipe(take(1))
      .subscribe(data => {
